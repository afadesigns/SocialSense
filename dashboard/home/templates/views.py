...
from admin_black_pro.forms import (
    RegistrationForm,
    LoginForm,
...
def fullscreen_map(request):
    context = {"parent": "maps", "segment": "full_screen_map"}
    return render(request, "pages/maps/fullscreen.html", context)


@login_required(login_url="/accounts/login/")
def vector_map(request):
    context = {"parent": "maps", "segment": "vector_map"}
...
def register(request):
    ...
    context = {"segment": "register_page", "form": form}
...
class UserPasswrodResetConfirmView(PasswordResetConfirmView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(UserPasswrodResetConfirmView, self).get_context_data(
            *args, **kwargs
        )
...
class UserPasswordResetDoneView(PasswordResetDoneView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(UserPasswordResetDoneView, self).get_context_data(
            *args, **kwargs
        )
...
class UserPasswordResetCompleteView(PasswordResetCompleteView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(UserPasswordResetCompleteView, self).get_context_data(
            *args, **kwargs
        )
...
class UserPasswordChangeDoneView(PasswordChangeDoneView):
    ...
    def get_context_data(self, *args, **kwargs):
        context = super(UserPasswordChangeDoneView, self).get_context_data(
            *args, **kwargs
        )
