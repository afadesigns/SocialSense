...
# Create a new lockfile with all the installed packages
echo "Creating a lockfile with all the installed packages..."
...
echo "Rebuild containers to verify that there are no conflicts..."
